      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li>
         ...
         <ul class="treeview-menu">
					<li class="treeview">
				  <a href="#">
					<i class="fa fa-fw fa-university"></i> <span>Department</span>s
					<span class="pull-right-container">
					  <i class="fa fa-angle-left pull-right"></i>
					</span>
				  </a>	  
				 ...
				 <!-- <a href="#">
					<i class="fa fa-fw fa-laptop"></i><span>Computer Science</span>
					<span class="pull-right-container">
					  <i class="fa fa-angle-left pull-right"></i>
					</span>
				  </a>	  
				  <ul class="treeview-menu">
					<li><a href="table_subject.php"><i class="fa fa-fw fa-table"></i> <span>Computer Network</span></a></li>
					 <li><a href="table_subject.php"><i class="fa fa-fw fa-table"></i> <span>IT and Envionment</span></a></li>
					  <li><a href="table_subject.php"><i class="fa fa-fw fa-table"></i> <span>Computer Fundamentals</span></a></li>
				  </ul>-->
				</li>
			</ul>
        </li>
...
?>		
           <li class="treeview">
              <a href="#"><i class="fa fa-circle-o"></i> <?php echo str_replace('Department of','',$dept_name);?>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
			   ...
			   ?>			   
                ...
                <li><a href="#"><i class="fa fa-circle-o"></i> <?php echo $subject_name;?></a></li>
