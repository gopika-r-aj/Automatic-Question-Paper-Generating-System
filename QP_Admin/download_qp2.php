      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <?php 
            ...
            $teachr=$obj->getAll('SELECT a.*,b.*,c.* FROM pdf_files a, department b,subject c WHERE a.uploaded_date <= DATE_ADD(CURDATE(), INTERVAL -30 DAY) AND a.subject_name=b.dept_id AND a.course_name=c.sub_id ');
            foreach($teachr as $value)
            {
