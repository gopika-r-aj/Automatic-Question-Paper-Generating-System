...
<body>
		...
		<div class="container">
			...
			<table id="example2" border="0" cellspacing="0" cellpadding="0">
				...
				<tbody>
					...
					$module4=$_POST['mod_4'];
					$module5=$_POST['mod_5'];
                  // echo $condition=$module1.$module2.$module3.$module4.$module5;
					$partA=$obj->getAll("SELECT * FROM `question` WHERE `question_type`='2' AND  `sub_id`=$sub AND $module1 $module2 $module3 $module4 $module5 ORDER BY RAND() LIMIT $limitA");
						$i=1;
			...
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<tbody>
					<?php
						$limitB=$_POST['part_b'];
						$sub=$_POST['subject'];
					// $condition=$module1.$module2.$module3.$module4.$module5;
					
					
					//echo "SELECT * FROM `question` WHERE `question_type`='5' AND `sub_id`=$sub AND  $module1 $module2 $module3 $module4 $module5 ORDER BY RAND() LIMIT $limitB";
					
					
						$partB=$obj->getAll("SELECT * FROM `question` WHERE `question_type`='5' AND `sub_id`=$sub AND  $module1 $module2 $module3 $module4 $module5 ORDER BY RAND() LIMIT $limitB");
						$i=$limitA+1;
			...
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<tbody>
					...
					$module5=$_POST['mod_5'];
					 //echo $condition=$module1.$module2.$module3.$module4.$module5;
					// echo "SELECT * FROM `question` WHERE `question_type`='15' AND `sub_id`=$sub AND  $module1 $module2 $module3 $module4 $module5 ORDER BY RAND() LIMIT $limitC";
						$partC=$obj->getAll("SELECT * FROM `question` WHERE `question_type`='15' AND `sub_id`=$sub AND  $module1 $module2 $module3 $module4 $module5 ORDER BY RAND() LIMIT $limitC");
						$i=$limitB+$limitA+1;
	...
	<footer>
		<div class="container">
			...
			<div class="end">
				<div class="container">Question Paper Created by <div class="thanks">EasyExam</div>
					
				</div>
				<button class="butt" type="button" onclick="myFunction()">Print this page</button>
		</div>
	</footer>
