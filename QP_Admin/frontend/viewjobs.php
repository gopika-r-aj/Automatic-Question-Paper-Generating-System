    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12" style="background-color: #fff; padding: 20px;">
                <?=$alertbox;?>
	                  <div class="col-lg-12">
						<H6 style="color:red;">Note: We usually displays all jobs posted by a company. Please check your preferred job location before attending the online test </H6>
                                ...
                                <div class="dataTable_wrapper">
                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <div>
                                                    <a href="<?=base_url('user/attendexam/')?><?=$jid;?>/<?=$cid;?>">
